<%@page import="com.boot.pojo.likedbooks"%>
	...
	<%
		...
		<h2>
			...
			<a href="<%=request.getContextPath()%>/likedbooks" class="lmove"><button
				...
				</button> <a href="viewbooks"><button
					class="glow-on-hover">
		...
		<div class="contentsdisp">
			<%
			List<likedbooks> bookies = (List<likedbooks>) request.getAttribute("books");

			for (likedbooks book : bookies) {
			%>
			<div class="backg">
				<div class="center">
				...
				<p class="lrbutton">
					<a href="<%=request.getContextPath()%>/deleteliked?value=<%=book.getId()%>"><Button type="submit" id=""
							class="rbstyle">Remove</Button></a>
				</p>
			</div>
			<%} %>
		</div>
